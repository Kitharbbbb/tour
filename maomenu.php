...
<body><header class="p-3 mb-3 ">
  ...
  <div class="jm">
    <div class="main">
      <div class="img">
        <img src="/img/photo-1507525428034-b723cf961d3e.jpg" style="width:100%" >
      </div>
      <div class="content">
        <a href="" target="_parent" style="text-decoration: none;">
          <h1><a href="package.php" target="_parent">mao trip package</a> </h1>
        </a>
      </div>
    </div>
    <div class="main">
      ...
      <div class="content">
        <h1>
          <a href="package.php" target="_parent">mao trip package
          </a>
        </h1>
      </div>
    </div>
